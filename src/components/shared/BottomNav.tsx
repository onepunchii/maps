...
export function BottomNav() {
    ...
    useEffect(() => {
        // Only apply scroll behavior on the contest page
        if (pathname !== "/contest") {
            setIsVisible(true);
            return;
        }
    ...
    return (
        <nav
            className={cn(
                "fixed bottom-6 left-6 right-6 z-50 bg-bg-card/90 backdrop-blur-md rounded-3xl border border-[#333] shadow-2xl p-2 px-6 transition-transform duration-300",
